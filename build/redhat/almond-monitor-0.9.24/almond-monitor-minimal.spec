...
Requires:       python3, python3-yaml, python3-simplejson, python3-flask, python3-gunicorn, python3-cryptography, ksh, sysstat, json-c
...
%changelog
* Mon Feb 16 2026 0.9.24
<andreas.lindell@almondmonitor.com>
- Monitor API added live check
