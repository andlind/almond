...
BuildRequires:  gcc
BuildRequires:  make, json-c-devel, librdkafka-devel, openssl-devel, zlib-devel, libcurl
# Conditional BuildRequires
%{?with_avro:BuildRequires: libserdes}
Requires:       python3, python3-yaml, python3-simplejson, python3-flask, python3-gunicorn, python3-cryptography, python3-jose, ksh, sysstat, json-c, librdkafka, libjwt
