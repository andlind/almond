...
from otel.nagios_to_otel import nagios_to_otel
from otel.otel_exporter import export_otel_data
from otel.otel_exporter import CollectorConnectionError, set_otlp_endpoint
...
def load_conf():
    ...
    if otlp_export_interval < 5:
        otlp_export_interval = 5
