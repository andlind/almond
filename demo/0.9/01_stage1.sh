...
nohup docker run --rm --platform linux/amd64 --net almond-redpanda-quickstart_almond-demo --name customapp_demo -d -v ~/almond_demo/data:/opt/almond/data -p 8076:8099 -p 9909:9909 custapplication
