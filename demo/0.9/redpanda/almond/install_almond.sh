...
echo "Installing dependencies"
docker cp ../../alpine/almond/almond-0.9.18.alpine.aarch64.tar.gz redpanda-console-10:/tmp
...
docker exec -u 0 redpanda-console-10 tar xfvz /tmp/almond-0.9.18.alpine.aarch64.tar.gz 
echo "Installing precompiled Almond"
docker exec -u 0 redpanda-console-10 /bin/sh -c "cd almond-0.9.18.alpine.aarch64 && ./install.sh"
echo "Installation finished"
echo "Start Almond"
